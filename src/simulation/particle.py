...
class ThreeDParticle(simulation.dynamic_system.DynamicSystem):
    """Implements the dynamics to simulate a particle with dynamics in 3d"""
    def __init__(
        self,
        X0,
        dt,
    ...
    def _dynamics(self, X, U):
        ...
        vydot = U[1]
        vzdot = U[2]
        X_dot = numpy.array([xdot, ydot, zdot, vxdot, vydot, vzdot])
        return X_dot
